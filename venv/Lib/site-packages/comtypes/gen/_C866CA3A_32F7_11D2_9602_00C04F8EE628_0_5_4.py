...
__all__ = [
    ...
    'DISPID_SPRFirstElement', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SRCERecognizerStateChange',
    'ISpNotifyTranslator', 'DISPID_SPEAudioSizeBytes',
    'SPDKL_CurrentConfig', 'SAFT11kHz8BitMono',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLWLangId', 'ISpDataKey',
    'ISpNotifySink', 'SDTDisplayText', 'DISPID_SRGDictationLoad',
    'SPVPRI_OVER', 'SVEEndInputStream', 'DISPID_SPEDisplayAttributes',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_PRIVATE4', 'SPEI_ADAPTATION',
    'SREAllEvents', 'DISPID_SVSkip', 'SpeechAudioFormatGUIDWave',
    'DISPID_SCSBaseStream', 'SPGRAMMARSTATE', 'SPEI_MAX_TTS',
    'SVSFUnusedFlags', 'SVSFParseAutodetect', 'SAFTADPCM_44kHzStereo',
    'SGDSActiveUserDelimited', 'DISPID_SGRSTWeight',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_PROPERTY_NUM_CHANGE',
    'SGDSActiveWithAutoPause',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpObjectTokenCategory', 'DISPID_SOTCId', 'SRSEIsSpeaking',
    'SPEI_MIN_SR', 'DISPID_SLPType', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPEsCount', 'DISPID_SpeechRecognizer', 'SVP_15',
    'DISPID_SRCEAdaptation', 'SPEI_WORD_BOUNDARY',
    '_ISpeechRecoContextEvents', 'SpeechCategoryVoices',
    'DISPID_SRCPause', 'ISpeechAudio', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRAudio', 'SPPS_RESERVED4', 'SVP_21',
    'DISPID_SVSPhonemeId', 'DISPID_SPEs_NewEnum',
    'DISPID_SPRulesItem', 'ISpRecoContext2', 'DISPID_SDKEnumValues',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SGRAddState',
    'DISPID_SGRId', 'SPSVerb', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRRRecoContext', 'DISPID_SAVolume', 'SpeechRunState',
    'SPRECOSTATE', 'ISpeechDataKey', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPEActualConfidence', 'ISpRecognizer',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRGetRecognizers',
    'SPWT_LEXICAL', 'ISpeechPhraseInfo', 'DISPID_SpeechPhraseInfo',
    'SVSFNLPMask', 'SAFTCCITT_ALaw_8kHzStereo', 'SVSFParseMask',
    'DISPID_SDKDeleteValue', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRGReset',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpUnCompressedLexicon',
    'ISpeechLexiconWords', 'eLEXTYPE_PRIVATE20', 'DISPIDSPTSI',
    'DISPID_SPCLangId', 'DISPID_SABufferInfo', 'SP_VISEME_21',
    'DISPID_SPIAudioSizeBytes', 'SPSModifier',
    'DISPID_SWFEBitsPerSample', 'SSTTWildcard', 'SPFM_CREATE',
    'tagSTATSTG', 'SGRSTTWildcard', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT44kHz16BitStereo', 'ISpeechGrammarRule', 'DISPID_SBSRead',
    'DISPID_SPARecoResult', 'SpeechVoicePriority',
    'ISpeechGrammarRuleStateTransition', 'SpeechGrammarTagWildcard',
    'DISPID_SAEventHandle', 'SPSHT_OTHER',
    'DISPID_SRAudioInputStream', 'SPAS_CLOSED', 'ISpResourceManager',
    'DISPID_SRRTimes', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPELexicalForm', 'DISPID_SPPChildren', 'SRAExport',
    'ISpeechGrammarRules', 'SPSEMANTICFORMAT',
    'SpeechEngineConfidence', 'SPPARTOFSPEECH', 'SPFM_OPEN_READWRITE',
    'SVPAlert', 'DISPID_SLPLangId', 'SPEI_REQUEST_UI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechAudioFormat', 'DISPID_SOTCSetId', 'SP_VISEME_14',
    'DISPID_SpeechPhraseRules', 'SPEI_END_SR_STREAM',
    'DISPID_SWFEChannels', 'SpeechPropertyResponseSpeed',
    'SAFTGSM610_44kHzMono', 'SpNotifyTranslator',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechLexiconWord',
    'ISpeechRecognizer', 'SpObjectTokenCategory', 'SPEI_PHRASE_START',
    'DISPID_SVIsUISupported', 'DISPID_SGRsFindRule',
    'SpeechRetainedAudioOptions', 'DISPIDSPTSI_ActiveLength',
    'STCRemoteServer', 'SVEAllEvents', 'DISPID_SVVoice',
    'SAFTCCITT_uLaw_44kHzStereo', 'SSSPTRelativeToStart',
    'ISpPhoneticAlphabetSelection', 'SpeechWordType',
    'DISPID_SRSClsidEngine', 'SpeechGrammarWordType', 'SPSNoun',
    'IStream', 'DISPID_SRDisplayUI', 'ISpeechRecoResultDispatch',
    'ISpeechObjectTokenCategory', 'DISPID_SPPs_NewEnum', 'SpLexicon',
    'ISpShortcut', 'DISPID_SDKSetLongValue', 'SPCS_DISABLED',
    'DISPID_SpeechRecoContext', 'SVP_10',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SECLowConfidence',
    'SpSharedRecognizer', 'DISPID_SOTCDefault',
    'SPEI_START_SR_STREAM', 'SRARoot', 'ISpStreamFormat',
    'SpeechStreamSeekPositionType', 'SAFTCCITT_ALaw_22kHzMono',
    'SREBookmark', 'SpPhoneConverter', 'SP_VISEME_8', 'SREStreamEnd',
    'DISPID_SLAddPronunciation', 'eWORDTYPE_ADDED',
    'SpeechDiscardType', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SOTsCount', 'ISpeechFileStream', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_PRIVATE6',
    'SPEI_TTS_PRIVATE', 'eLEXTYPE_RESERVED4', 'DISPID_SPCPhoneToId',
    'SpeechVoiceEvents', 'SP_VISEME_20', 'SPEI_RESERVED3',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE12',
    'SVSFPersistXML', 'SPEI_SOUND_END', 'DISPID_SRGetPropertyNumber',
    'SRTReSent', 'SPWF_INPUT', 'SPDKL_LocalMachine',
    'Speech_Max_Pron_Length', 'ISpeechLexiconPronunciations',
    'DISPID_SGRSTNextState', 'SAFTExtendedAudioFormat',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT22kHz16BitStereo',
    'SVP_5', 'SpeechGrammarState', 'DISPID_SLPsCount',
    'SpeechTokenKeyFiles', 'DISPID_SpeechPhraseAlternate',
    'SECFIgnoreKanaType', 'SREFalseRecognition', 'SP_VISEME_17',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SOTRemoveStorageFileName', 'SPAR_Unknown',
    'eLEXTYPE_PRIVATE15', 'SPSSuppressWord', 'DISPID_SBSWrite',
    'DISPID_SpeechLexiconProns', 'DISPID_SLRemovePronunciation',
    'STCLocalServer', 'eLEXTYPE_RESERVED8',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRAttributes',
    'ISpeechRecognizerStatus', 'DISPID_SPPId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTsItem',
    'DISPID_SWFEAvgBytesPerSec', 'SPGS_EXCLUSIVE', 'DISPID_SPACommit',
    'SAFTGSM610_11kHzMono', 'DISPID_SOTCreateInstance',
    'DISPID_SVGetAudioOutputs', 'SVP_12', 'DISPID_SPAPhraseInfo',
    'ISpRecoCategory', 'ISpXMLRecoResult', 'SGLexicalNoSpecialChars',
    'SITooSlow', 'SpSharedRecoContext', 'SDTLexicalForm',
    'ISpPhoneticAlphabetConverter', 'SPAR_High',
    'DISPID_SpeechVoiceEvent', 'DISPID_SVEPhoneme',
    'SPDATAKEYLOCATION', 'SVEWordBoundary', 'eLEXTYPE_PRIVATE7',
    'SPEI_RECOGNITION', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_RESERVED7', 'SSFMOpenForRead', 'SVP_20',
    'DISPID_SVSpeakStream', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SVSRunningState',
    'DISPID_SPRules_NewEnum', 'SRSInactiveWithPurge',
    'SAFT48kHz16BitStereo', 'SGDSInactive', 'SpeechAudioProperties',
    'SpeechDisplayAttributes', 'SPPS_Verb',
    'DISPID_SpeechRecoContextEvents', 'SVEPrivate', 'SVP_11',
    'DISPID_SOTRemove', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPIRule', 'DISPID_SPIGetText', 'SPEI_RESERVED2',
    'SpeechRecognizerState', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVEStreamStart', 'DISPID_SpeechLexicon', 'SGRSTTWord',
    'SDKLCurrentUser', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRsItem',
    'DISPID_SVSLastBookmark', 'SAFT16kHz8BitStereo',
    'SpeechTokenContext', 'SVEAudioLevel', 'ISpeechAudioBufferInfo',
    'SPRS_INACTIVE', 'SREStreamStart', 'ISpeechPhraseProperties',
    'SRERecognition', 'SpeechAddRemoveWord', 'SpNullPhoneConverter',
    'DISPID_SpeechPhraseBuilder', 'SpeechCategoryPhoneConverters',
    'SpPhoneticAlphabetConverter', 'eLEXTYPE_LETTERTOSOUND',
    'SVPNormal', 'SAFTADPCM_8kHzStereo', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVSpeakCompleteEvent', 'SPINTERFERENCE_NONE',
    'SRCS_Enabled', 'SPSInterjection', 'eLEXTYPE_RESERVED9',
    'SRAONone', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCEStartStream', 'UINT_PTR',
    'DISPID_SpeechPhraseReplacement', 'SVP_17', 'SREPrivate',
    'DISPID_SREmulateRecognition',
    'DISPID_SRCERecognitionForOtherContext',
    'SPWORDPRONUNCIATIONLIST', 'SpeechLoadOption',
    'DISPID_SLWPronunciations', 'DISPID_SVSInputWordPosition',
    'SVP_6', 'SREAdaptation', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPAs_NewEnum', 'DISPID_SPAsItem', 'SPPS_Unknown',
    'DISPID_SPRuleId', 'SVSFIsNotXML', 'SPWF_SRENGINE',
    'DISPID_SOTs_NewEnum', 'DISPID_SPPFirstElement',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE8', 'DISPID_SAFGuid',
    'SpWaveFormatEx', 'DISPID_SGRsCommitAndSave',
    'SRERecoOtherContext', 'SPBINARYGRAMMAR', 'ISpeechWaveFormatEx',
    'SPRST_NUM_STATES', 'SPEI_START_INPUT_STREAM', 'SPWORDTYPE',
    'DISPID_SRCERecognition', 'SVSFNLPSpeakPunc',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVGetAudioInputs', 'DISPID_SLPSymbolic', 'SPPROPERTYINFO',
    'SINone', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPEPronunciation', 'SPVPRI_ALERT', 'SPBOOKMARKOPTIONS',
    'DISPID_SVVolume', 'ISpeechRecoContext', 'ISpProperties',
    'DISPID_SPRuleConfidence', 'SGRSTTTextBuffer', 'SpShortcut',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'WAVEFORMATEX',
    'DISPID_SWFESamplesPerSec', 'SDKLDefaultLocation',
    'SSTTDictation', 'ISpeechPhraseRules', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPIReplacements', 'SPBO_NONE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLWs_NewEnum',
    'DISPID_SVRate', 'eLEXTYPE_PRIVATE10', 'SPINTERFERENCE_TOOLOUD',
    'SP_VISEME_2', 'SpeechVoiceSkipTypeSentence',
    'SPEI_FALSE_RECOGNITION', 'SpeechPropertyLowConfidenceThreshold',
    'SPAO_RETAIN_AUDIO', 'SPINTERFERENCE_TOOSLOW', 'SWTAdded',
    'SWPKnownWordPronounceable', 'DISPID_SBSFormat', 'SREHypothesis',
    'DISPID_SVPause', 'SPEI_UNDEFINED', 'DISPID_SPPConfidence',
    'DISPID_SLWsCount', 'SAFT16kHz16BitStereo',
    'ISpeechPhraseReplacement', 'SRSEDone',
    'DISPID_SpeechGrammarRuleState', 'eLEXTYPE_PRIVATE9',
    'DISPID_SOTSetId', 'STSF_CommonAppData',
    'IInternetSecurityManager', 'DISPID_SpeechWaveFormatEx',
    'SVEStartInputStream', 'SPGS_ENABLED', 'DISPID_SPRsCount',
    'DISPID_SRCEFalseRecognition', 'SRCS_Disabled', 'SpeechRuleState',
    'SAFT11kHz8BitStereo', 'SpeechCategoryRecognizers',
    'SpeechSpecialTransitionType', 'SPCT_SUB_COMMAND',
    'DISPIDSPTSI_SelectionLength', 'SPRST_ACTIVE_ALWAYS',
    'SAFTADPCM_8kHzMono', 'SPLO_STATIC', 'SVP_4',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRs_NewEnum',
    'DISPID_SMSSetData', 'DISPIDSPTSI_SelectionOffset',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFT24kHz16BitMono',
    'SAFTADPCM_11kHzMono', 'DISPID_SOTId',
    'DISPID_SpeechCustomStream', 'IEnumString', 'SP_VISEME_6',
    'SPLEXICONTYPE', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechAudio', 'SLODynamic', 'SRSActiveAlways',
    'SAFTADPCM_22kHzMono', 'SAFT12kHz8BitStereo',
    'SpeechPartOfSpeech', 'SVF_Stressed',
    'DISPID_SRSSupportedLanguages', 'DISPID_SWFEBlockAlign',
    'DISPID_SPIProperties', 'SAFT48kHz16BitMono',
    'DISPID_SRSetPropertyNumber', 'SVSFlagsAsync',
    'DISPID_SRRecognizer', 'ISpeechRecoResult', 'SPAUDIOOPTIONS',
    'DISPID_SRSCurrentStreamNumber', 'SPSEMANTICERRORINFO',
    'DISPID_SGRSTsItem', 'DISPID_SRGSetTextSelection',
    'SAFT24kHz8BitMono', 'SECFDefault', 'DISPID_SOTIsUISupported',
    'DISPID_SVResume', 'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE14',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPPS_SuppressWord',
    'SSFMCreate', 'SRADefaultToActive', 'ISpeechAudioFormat',
    'ISpeechLexiconPronunciation', 'SECFIgnoreWidth',
    'SSSPTRelativeToEnd', 'SWPUnknownWordUnpronounceable',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechXMLRecoResult',
    'SPEI_VOICE_CHANGE', 'SpeechEmulationCompareFlags',
    'DISPID_SPEAudioSizeTime', 'SECNormalConfidence',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRState',
    'SDA_One_Trailing_Space', 'SPPS_Noncontent',
    'DISPID_SDKSetStringValue', 'STCAll', 'ISpObjectToken',
    'ISpAudio', 'SVESentenceBoundary', 'DISPID_SVEWord',
    'SPAUDIOBUFFERINFO', 'DISPID_SMSALineId', 'DISPID_SGRSTText',
    'SPRECOCONTEXTSTATUS', 'DISPID_SASFreeBufferSpace',
    'DISPIDSPTSI_ActiveOffset', 'SpeechPropertyAdaptationOn',
    'DISPID_SRRTLength', 'DISPID_SPIEngineId', 'SPLOADOPTIONS',
    'SVP_1', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'tagSPTEXTSELECTIONINFO', 'SWTDeleted',
    'DISPID_SPERequiredConfidence', 'DISPID_SAFGetWaveFormatEx',
    'SAFTNonStandardFormat', 'SAFTCCITT_uLaw_22kHzMono',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPRNumberOfElements',
    'ISpObjectWithToken', 'DISPID_SpeechAudioStatus',
    'DISPID_SPPsCount', 'DISPID_SRCEAudioLevel',
    'DISPID_SRGRecoContext', 'SPAO_NONE', 'SpeechCategoryAppLexicons',
    'DISPID_SPEsItem', 'SPSTREAMFORMATTYPE', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechPhoneConverter', 'DISPID_SLGenerationId',
    'DISPID_SVSInputSentenceLength', 'SPCT_COMMAND', 'SP_VISEME_18',
    'DISPID_SPIAudioStreamPosition', 'SAFTADPCM_22kHzStereo',
    'SpeechAudioFormatGUIDText', 'SFTInput', 'DISPID_SRGRules',
    'SPPS_Function', 'DISPID_SVEViseme', 'SPAUDIOSTATE',
    'DISPID_SRRAudioFormat', 'SPGRAMMARWORDTYPE', 'DISPID_SAFType',
    'SPPS_RESERVED3', 'DISPID_SFSClose', 'ISpeechBaseStream',
    'DISPID_SpeechPhraseElements', 'ISpeechRecoGrammar',
    'SPWORDPRONOUNCEABLE', 'SAFTCCITT_uLaw_44kHzMono', 'SDTProperty',
    'SITooFast', 'SpeechRegistryUserRoot', 'SPCATEGORYTYPE',
    'SRAImport', 'SPPS_LMA', 'SpeechFormatType', 'eLEXTYPE_APP',
    'SASRun', 'SpeechDataKeyLocation', '_RemotableHandle',
    'SAFT11kHz16BitMono', 'DISPID_SVSVisemeId',
    'DISPID_SOTGetDescription', 'DISPID_SRCreateRecoContext',
    'DISPID_SGRSTRule', 'SRTSMLTimeout', 'SGDisplay',
    'DISPID_SRRSaveToMemory', 'DISPID_SPAsCount',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEventInterests',
    'SPVPRI_NORMAL', 'Speech_StreamPos_RealTime', 'SPPS_RESERVED2',
    'SREInterference', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SASCurrentDevicePosition', 'SPFM_OPEN_READONLY',
    'DISPID_SVSpeak', 'DISPID_SABIBufferSize', 'DISPID_SABIEventBias',
    'SPSUnknown', 'DISPID_SVEStreamEnd', 'SDTRule',
    'DISPID_SRCEPropertyNumberChange', 'SAFT22kHz8BitStereo',
    'DISPID_SPAStartElementInResult', 'DISPID_SRGCommit',
    'DISPID_SPRuleChildren', 'ISpeechPhraseAlternate',
    'ISpRecognizer2', 'SPLO_DYNAMIC', '_ISpeechVoiceEvents',
    'DISPID_SWFEExtraData', 'ISpeechCustomStream',
    'DISPID_SPRuleFirstElement', 'SREStateChange',
    'DISPID_SRGDictationSetState',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SVEBookmark',
    'DISPID_SpeechPhraseProperties', 'SDTAudio', 'ISpEventSink',
    'DISPID_SRCEHypothesis', 'DISPID_SPPEngineConfidence',
    'SpPhraseInfoBuilder', 'DISPID_SPEEngineConfidence',
    'SPINTERFERENCE_NOSIGNAL', 'SITooQuiet',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT12kHz16BitMono',
    'SAFT12kHz8BitMono', 'SAFT48kHz8BitStereo',
    'SPXRO_Alternates_SML', 'DISPID_SpeechLexiconWords',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpRecoResult', 'tagSPPROPERTYINFO', 'SPSHORTCUTTYPE',
    'SRTEmulated', 'DISPID_SRGCmdLoadFromResource', 'SPAUDIOSTATUS',
    'SP_VISEME_0', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLGetWords',
    'ISpRecoContext', 'SP_VISEME_1', 'SPRST_INACTIVE',
    'DISPID_SpeechDataKey', 'SpeechVoiceCategoryTTSRate',
    'SP_VISEME_16', 'SpeechMicTraining', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRIsShared', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRsDynamic', 'SPEI_MIN_TTS', 'SPEVENT', 'SPAR_Low',
    'ISpVoice', 'SAFT16kHz8BitMono', 'ISpNotifySource',
    'SpeechCategoryAudioIn', 'SpeechDictationTopicSpelling',
    'DISPID_SRCBookmark', 'SPWORDPRONUNCIATION',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechAudioState',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SASetState', 'ISpeechObjectToken', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVSInputWordLength',
    'SDTPronunciation', 'SPPHRASE', 'SpeechRuleAttributes',
    'DISPID_SADefaultFormat', 'SPPHRASEPROPERTY',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechBookmarkOptions',
    'SVSFDefault', 'ISpeechVoice', 'SDTAll', 'SVP_19',
    'SAFTCCITT_ALaw_22kHzStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SRRSetTextFeedback', 'SRAInterpreter', 'SPEI_HYPOTHESIS',
    'SPCT_DICTATION', 'SPEI_RESERVED1', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRCRecognizer', 'ISpeechGrammarRuleState',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRAddResource',
    'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_11', 'SRTExtendableParse',
    'DISPID_SRCEEndStream', 'IInternetSecurityMgrSite',
    'DISPID_SpeechPhraseProperty', 'SLOStatic', 'SPEVENTSOURCEINFO',
    'DISPID_SGRSTType', 'SPINTERFERENCE',
    'DISPID_SLGetPronunciations', 'SAFT24kHz16BitStereo',
    'DISPID_SGRSTs_NewEnum', 'SpResourceManager',
    'SpeechEngineProperties', 'SRATopLevel', 'ISpGrammarBuilder',
    'SSTTTextBuffer', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SLTUser', 'DISPID_SpeechObjectTokens', 'DISPID_SRGId',
    'SAFT44kHz8BitMono', 'SpInProcRecoContext',
    'DISPID_SpeechRecoResult', 'SRAORetainAudio',
    'DISPID_SASCurrentSeekPosition', 'eWORDTYPE_DELETED',
    'SPCT_SUB_DICTATION', 'DISPID_SRCState',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechLexiconWord', 'SRSInactive',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRsCount', 'ISpEventSource',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVEVoiceChange',
    'SVP_18', 'SPFILEMODE', 'ISpeechPhoneConverter',
    'ISequentialStream', 'SpeechInterference', 'DISPID_SGRsAdd',
    'SPEI_END_INPUT_STREAM', 'ISpeechRecoResult2',
    'Speech_Max_Word_Length', 'SPXRO_SML', 'DISPID_SVDisplayUI',
    'SVP_0', 'SINoSignal', 'DISPID_SGRSTPropertyId', 'SPPHRASERULE',
    'SPSHT_EMAIL', 'DISPID_SBSSeek', 'DISPID_SDKDeleteKey',
    'SAFT24kHz8BitStereo', 'DISPID_SLWWord', 'SINoise',
    'SGPronounciation', 'DISPID_SPANumberOfElementsInResult',
    'SpMMAudioOut', 'SAFT12kHz16BitStereo', 'SpeechAllElements',
    'eLEXTYPE_PRIVATE19', 'ISpeechObjectTokens', 'SPBO_AHEAD',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechRecoResult2',
    'SVSFIsFilename', 'SP_VISEME_10', 'SVSFParseSapi',
    'DISPID_SRCVoicePurgeEvent', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPIDSPRG', 'SP_VISEME_15', 'SLTApp', 'DISPID_SRRTTickCount',
    'ISpStreamFormatConverter', 'SBOPause', 'SpMemoryStream',
    'DISPID_SVEAudioLevel', 'DISPID_SRCERequestUI', 'SPCS_ENABLED',
    'ISpeechPhraseElement', 'DISPID_SASState', 'SREPropertyNumChange',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SDA_Consume_Leading_Spaces',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCEPhraseStart',
    'SpeechCategoryAudioOut', 'SAFTGSM610_22kHzMono',
    'SPEI_SR_BOOKMARK', 'DISPID_SRGCmdSetRuleState',
    'ISpeechPhraseProperty', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SAFSetWaveFormatEx', 'SPRECOGNIZERSTATUS',
    'DISPID_SGRInitialState', 'SVP_14', 'DISPID_SVStatus',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SLPPhoneIds',
    'SRESoundStart', 'SpeechTokenKeyUI', 'SPRULE',
    'DISPID_SPCIdToPhone', 'DISPID_SRRTStreamTime',
    'DISPID_SRSAudioStatus', 'SAFT22kHz8BitMono', 'SPWORDLIST',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpMMSysAudio',
    'SPSLMA', 'ISpeechPhraseElements', 'DISPID_SPRuleName',
    'SPEI_RECO_STATE_CHANGE', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPRsItem', 'SpeechTokenValueCLSID',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRGCmdLoadFromMemory',
    'SPFM_NUM_MODES', 'SpeechAudioVolume', 'SSFMOpenReadWrite',
    'ISpeechResourceLoader', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechVisemeFeature', 'DISPID_SPIElements', 'SPRECORESULTTIMES',
    'SpeechRecoEvents', 'SP_VISEME_12', 'ISpeechVoiceStatus',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLGetGenerationChange',
    'SVSFPurgeBeforeSpeak', 'DISPID_SPRuleParent',
    'DISPID_SGRSTsCount', 'ISpeechMMSysAudio', 'SAFT11kHz16BitStereo',
    'DISPID_SRCRetainedAudioFormat', 'SGLexical',
    'DISPID_SRCEInterference', 'DISPID_SGRSRule',
    'DISPID_SRGDictationUnload', 'SAFTText', 'eLEXTYPE_RESERVED6',
    ...
    'DISPID_SRSetPropertyString', 'SGSEnabled', 'SVEPhoneme',
    'DISPID_SABIMinNotification', 'SpeechRecoContextState',
    'SWPUnknownWordPronounceable', 'SAFT32kHz16BitStereo',
    'DISPID_SVSCurrentStreamNumber', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRAudioInput', 'SPRST_ACTIVE', 'SPINTERFERENCE_TOOQUIET',
    'SPPS_Noun', 'DISPID_SOTDisplayUI', 'DISPID_SRGetPropertyString',
    'DISPID_SRRDiscardResultInfo', 'SPEI_MAX_SR', 'SP_VISEME_4',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPRuleEngineConfidence',
    'SVSFVoiceMask', 'SpeechRecoProfileProperties',
    'SECFNoSpecialChars', 'STSF_AppData', 'DISPID_SVGetVoices',
    'DISPID_SpeechBaseStream', 'SpeechWordPronounceable',
    'SPPS_NotOverriden', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseElement',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechAudioFormatType',
    'DISPID_SOTGetStorageFileName', 'SRTAutopause', 'SPRULESTATE',
    'SP_VISEME_9', 'DISPID_SpeechRecognizerStatus',
    'ISpeechPhraseRule', 'DISPID_SPRs_NewEnum',
    'DISPID_SRRPhraseInfo', 'SAFT8kHz16BitStereo', 'SRADynamic',
    'SPEI_PHONEME', 'ISpeechPhraseAlternates', 'SREPhraseStart',
    'SGSExclusive', 'ISpSerializeState', 'SPEI_SR_RETAINEDAUDIO',
    'SPSMF_UPS', 'SPINTERFERENCE_NOISE', 'SGRSTTEpsilon',
    'SP_VISEME_3', 'eLEXTYPE_USER', 'DISPID_SVAudioOutput',
    'DISPID_SVEEnginePrivate', 'SP_VISEME_13', 'SpFileStream',
    'DISPID_SRGCmdSetRuleIdState', 'SPPS_RESERVED1',
    'DISPID_SpeechObjectToken', 'SPSERIALIZEDPHRASE',
    'SECFEmulateResult', 'SAFT8kHz8BitMono', 'DISPID_SDKEnumKeys',
    'SPSNotOverriden', 'Speech_Default_Weight', 'SVP_13',
    'DISPID_SPIStartTime', 'SpeechRecognitionType', 'SP_VISEME_5',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpPhrase', 'SpMMAudioIn',
    'DISPID_SLWType', 'SAFT32kHz16BitMono', 'DISPID_SRCResume',
    'SAFT32kHz8BitMono', 'SpeechPropertyResourceUsage',
    'SPWAVEFORMATTYPE', 'SPWT_PRONUNCIATION', 'SpStream',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SMSADeviceId',
    'SpCompressedLexicon', 'DISPID_SRRAlternates',
    'ISpeechMemoryStream', 'SPEI_RESERVED5', 'SPBO_TIME_UNITS',
    'DISPID_SABufferNotifySize', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPEVENTENUM', 'DISPID_SVPriority', 'DISPID_SpeechGrammarRule',
    'SVP_16', 'ISpeechTextSelectionInformation',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPPValue',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPPName', 'SPEI_RESERVED6',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechFileStream',
    'eLEXTYPE_USER_SHORTCUT', 'SPAS_PAUSE', 'DISPID_SMSAMMHandle',
    'ISpeechRecoResultTimes', 'DISPID_SRGetFormat',
    'DISPID_SGRSTPropertyName', 'SVEBookmark', 'STCInprocServer',
    'ISpeechPhraseInfoBuilder', 'eLEXTYPE_PRIVATE16',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFT48kHz8BitMono',
    'SPEI_INTERFERENCE', 'DISPID_SPERetainedStreamOffset', 'SPAS_RUN',
    'SPXMLRESULTOPTIONS', 'SpVoice', 'ISpPhraseAlt',
    'SpStreamFormatConverter', 'DISPID_SPRDisplayAttributes',
    'ISpeechPhraseReplacements', 'SDKLCurrentConfig',
    'SpeechUserTraining', 'DISPID_SLWsItem', 'DISPID_SVSLastResult',
    'SECHighConfidence', 'DISPID_SPIEnginePrivateData',
    'SPPS_Modifier', 'DISPID_SPPsItem', 'DISPID_SDKGetBinaryValue',
    'SPCT_SLEEP', 'DISPID_SGRsCommit', 'SDTAlternates', 'SASStop',
    'SAFT44kHz16BitMono', 'DISPID_SOTCategory', 'SVF_Emphasis',
    'DISPID_SDKGetlongValue', 'SpAudioFormat',
    'DISPID_SVAudioOutputStream', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechGrammarRules', 'SPPHRASEREPLACEMENT',
    'SDA_No_Trailing_Space', 'SRSActive', 'DISPID_SpeechMemoryStream',
    'ISpRecoGrammar2', 'SREAudioLevel', 'SPAR_Medium',
    'SpeechCategoryRecoProfiles', 'SPDKL_CurrentUser',
    'SREPropertyStringChange', 'DISPID_SRRGetXMLResult', 'SVP_8',
    'SPSERIALIZEDRESULT', 'DISPID_SRGState', 'ISpRecognizer3',
    'SPVISEMES', 'SPEI_SR_PRIVATE', 'DISPID_SpeechVoice',
    'SVEVoiceChange', 'SVPOver', 'SpMMAudioEnum',
    'DISPID_SPIAudioSizeTime', 'SGSDisabled',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCVoice', 'SAFTDefault',
    'DISPID_SRCESoundStart', 'DISPID_SpeechRecoResultTimes',
    'SPPHRASEELEMENT', 'SPWT_DISPLAY', 'ISpStream', 'DISPID_SGRClear',
    'SVP_3', 'ISpeechAudioStatus', 'SPBO_PAUSE',
    'DISPID_SRCRetainedAudio', 'SAFT32kHz8BitStereo',
    'SpCustomStream', 'SPAS_STOP', 'DISPID_SPIRetainedSizeBytes',
    'SPDKL_DefaultLocation', 'DISPID_SVSInputSentencePosition',
    'SVP_7', 'ISpeechLexicon', 'SSFMCreateForWrite', 'SDTReplacement',
    'SVEViseme', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechMMSysAudio', 'SECFIgnoreCase', 'STSF_FlagCreate',
    'SPSFunction', 'SPGS_DISABLED', 'SPCONTEXTSTATE',
    'SAFT16kHz16BitMono', 'LONG_PTR', 'DISPID_SRIsUISupported',
    'DISPID_SPILanguageId', 'IEnumSpObjectTokens',
    'DISPID_SOTGetAttribute', 'SBONone', 'SFTSREngine',
    'DISPID_SPRulesCount', 'SpeechVoiceSpeakFlags',
    'SpeechGrammarRuleStateTransitionType', 'SPVPRIORITY',
    'DISPID_SFSOpen', 'SPEI_VISEME', 'SRESoundEnd',
    'SpeechStreamFileMode', 'SVSFIsXML', 'SPPS_Interjection',
    'DISPID_SRRSpeakAudio', 'SAFTNoAssignedFormat', 'DISPID_SRStatus',
    'DISPID_SDKCreateKey', 'DISPID_SOTMatchesAttributes',
    'DISPID_SLPsItem', 'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE3',
    'SGRSTTRule', 'DISPID_SPPParent', 'DISPID_SVSLastBookmarkId',
    'SPWORD', 'SPSHT_Unknown', 'SGRSTTDictation',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRCSetAdaptationData',
    'DISPID_SASNonBlockingIO', 'SPEI_SOUND_START',
    'STSF_LocalAppData', '_SPAUDIOSTATE', 'DISPID_SPIGrammarId',
    'DISPID_SPEAudioStreamOffset', 'SRERequestUI', 'SITooLoud',
    'SVP_2', 'DISPID_SGRName', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SDKOpenKey', 'SP_VISEME_7', 'DISPID_SOTDataKey',
    'SDKLLocalMachine', 'SPSHT_NotOverriden', 'Speech_StreamPos_Asap',
    'SpeechGrammarTagDictation', 'SpeechTokenShellFolder',
    'SVSFParseSsml', 'ISpLexicon', 'SVP_9',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCESoundEnd',
    'SpeechLexiconType', 'SASPause', 'DISPID_SRCEBookmark',
    'SPRS_ACTIVE', 'SP_VISEME_19', 'STCInprocHandler',
    'SPEI_TTS_BOOKMARK', 'ISpPhoneConverter',
    'eLEXTYPE_VENDORLEXICON', 'SpObjectToken', 'SRTStandard',
    'DISPID_SGRSAddRuleTransition', 'SPSHORTCUTPAIR',
    'SpInprocRecognizer', 'DISPID_SMSGetData', 'SGDSActive',
    'DISPID_SGRSTransitions', 'ISpeechXMLRecoResult',
    'DISPID_SRProfile', 'SpeechVisemeType', 'DISPID_SPEDisplayText',
    'SpTextSelectionInformation', 'SVF_None', 'SASClosed',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechPhraseRule',
    'SpeechTokenIdUserLexicon', 'DISPID_SPRText',
    'SAFT22kHz16BitMono', 'ISpRecoGrammar', 'DISPID_SVEventInterests',
    'eLEXTYPE_PRIVATE17'
]

_check_version('1.2.0', 1640282163.425013)
